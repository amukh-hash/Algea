# create_shortcut.ps1 — Create a Desktop shortcut for Algae Dashboard
# Usage: powershell -ExecutionPolicy Bypass -File scripts\create_shortcut.ps1

$ErrorActionPreference = "Stop"
$WshShell = New-Object -ComObject WScript.Shell
$DesktopPath = [Environment]::GetFolderPath("Desktop")
$ShortcutFile = Join-Path $DesktopPath "Algae Dashboard v4.0.lnk"
$TargetFile = Join-Path (Split-Path -Parent $MyInvocation.MyCommand.Path) "ALGAE_DASHBOARD.bat"
...
$Shortcut.Description = "Launch Algae Trading Stack v4.0 (Backend, Orchestrator, Frontend)"
