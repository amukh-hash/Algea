...
from algea.research.equity_curve import build_equity_curve
from algea.research.metrics import compute_metrics
from algea.research.reports import build_summary
from algea.research.trade_log import build_trade_log
from algea.trading.calendar import trading_days
from algea.trading.costs import CommissionModel, SlippageModel
from algea.trading.fills import ExecutionSimulator, FillConfig
...
class BacktestEngine:
    ...
    def run(
        ...
        from algea.data.common import ensure_datetime
