    ...
    def connect(self) -> None:
        ...
        for attempt in range(1, self.max_retries + 1):
            try:
                ...
                # Request delayed data if paper trading port detected.
                # Paper accounts without live data subscriptions receive
                # nothing unless explicitly asked for delayed (type=3).
                if self.port in (7497, 4002):
                    self._ib.reqMarketDataType(3)  # 1=Live 2=Frozen 3=Delayed 4=DelayedFrozen
                    logger.info("IBKR paper port detected — reqMarketDataType(3) for delayed data")
                return
