...
Reads ``ALGAIE_CUDA_DEVICE`` from the environment to decide which GPU to use.
...
def get_device(override: str | None = None) -> torch.device:
    ...
    if override is not None:
        ...
        choice = os.environ.get("ALGAIE_CUDA_DEVICE", _DEFAULT_CUDA_DEVICE)
