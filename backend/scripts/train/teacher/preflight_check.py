...
def main():
    ...
    if not report["selector"]["ok"]:
        recs.append("Run 'python backend/scripts/priors/priors_build_nightly.py' or 'backend/scripts/train/selector_train_experimental.py'")
        
    report["recommendations"] = recs
    report["next_command"] = "python backend/scripts/infer/selector_infer_nightly.py" if all_ok else "Fix errors first"
