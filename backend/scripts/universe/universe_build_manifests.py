...
from backend.app.data import universe_selector
...
def main():
    ...
    while current <= end_dt:
        ...
        manifest = universe_selector.apply_universe_rules(metrics_df, rules)
        
        # Write
        out = universe_selector.write_universe_manifest(current, manifest, rules)
