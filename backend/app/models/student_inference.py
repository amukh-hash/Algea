...
class StudentRunner:
    def __init__(self, model_path: str, preproc_path: str, model_class: Type[torch.nn.Module] = BaselineMLP, device: str = "cpu"):
        ...
        feature_cols = ["log_return_1d", "log_return_5d", "log_return_20d", "volatility_20d", "volume_log_change_5d", "ad_line_trend_5d", "bpi_level"]
    ...
    def infer(self, df_window: pl.DataFrame) -> ModelSignal:
        ...
        return ModelSignal(horizons=horizons, quantiles=quantiles, direction_probs=direction_probs, metadata=self.metadata)
