...
class _Client:
    ...
    def vol_surface_grid_forecast(self, req, critical=True):
        return type("G", (), {"model_version": "g1", "grid_forecast": {"7:ATM": 0.3}, "uncertainty_proxy": 0.1, "mask_coverage": 0.9})()
...
@pytest.mark.xfail(strict=False, reason="PRE-EXISTING: VRPSleeve.generate_targets internal bug")
