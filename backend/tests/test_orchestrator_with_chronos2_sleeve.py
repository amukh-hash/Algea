...
def test_orchestrator_runs_with_chronos2_sleeve_enabled(tmp_path: Path, monkeypatch) -> None:
    monkeypatch.setenv("ORCH_ALLOW_STUB_SIGNALS", "1")
    monkeypatch.setenv("ENABLE_CHRONOS2_SLEEVE", "1")
    ...
    store.publish_version("chronos2", "v1", "x", {"pinball_loss": 0.1}, {"x": 1}, {"feature_schema": {}, "drift_baseline": {"mean": 100, "std": 5}, "calibration": {"calibration_score": 0.8}})
