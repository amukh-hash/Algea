...
@pytest.mark.asyncio
async def test_itransformer_endpoint_contract(tmp_path: Path):
    ...
    out = await server.itransformer_http_signal(ITransformerSignalRequest(asof="2026-01-01", symbols=["XLF"], feature_matrix=[[0.1, 0.2]], trace_id="it1"))
