...
def test_smoe_endpoint_contract(tmp_path: Path):
    ...
    out = s.smoe_http_rank(SMoERankRequest(asof="2026-01-01", symbols=["AAPL"], feature_matrix=[[0.1, 0.2]], trace_id="t", market_context={}))
