...
@pytest.mark.asyncio
async def test_vol_surface_endpoint_contract(tmp_path: Path):
    ...
    out = await s.vol_surface_http_forecast(VolSurfaceRequest(asof="2026-01-01", underlying_symbol="SPY", tenors=[7], history={7: [{"rv_hist_20": 0.2}] * 5}, trace_id="t"))
