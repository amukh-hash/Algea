...
@pytest.mark.asyncio
async def test_rl_policy_endpoint_contract(tmp_path: Path):
    ...
    payload = await s.rl_policy_http_act(RLPolicyRequest(asof="2026-01-01", sleeve="vrp", state={"a": 0.1}, proposal={"base_size": 0.02}, constraints={"max_multiplier": 1.0}, trace_id="rl1"))
