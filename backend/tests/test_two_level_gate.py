...
class TestGateDirection:
    ...
    def test_stress_lowers_w(self):
        from algae.models.ranker.baseline_scorer import compute_gate_weights
...
class TestGateMonotonicity:
    ...
    def test_sigmoid_decreasing_basic(self):
        from algae.models.ranker.baseline_scorer import sigmoid_gate
    ...
    def test_sanity_check_helper_detects_violation(self):
        from algae.models.ranker.baseline_scorer import sanity_check_gate_monotonicity
